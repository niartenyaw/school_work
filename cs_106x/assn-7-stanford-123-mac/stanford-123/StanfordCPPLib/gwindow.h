 ...
 * lines, rectangles, and ovals on the background letter without making
 ...
 * the control the control strip specified by the <code>region</code>
 * parameter which must be one of the strings <code>"NORTH"</code>,
